...
export async function GET(req:NextRequest){
 ...
 const body={using:["urn:ietf:params:jmap:core","urn:ietf:params:jmap:mail"],methodCalls:[["Email/get",{accountId,ids:[id],properties:["id","from","to","cc","subject","receivedAt","preview","textBody","htmlBody","bodyValues","attachments"],fetchTextBodyValues:true,fetchHTMLBodyValues:true,maxBodyValueBytes:2000000},"e"]]};
